...
All skills in this repository, sorted alphabetically with tags.
...
| [cicd](../skills/cicd/SKILL.md) | CI/CD pipeline design with Harness Drone | `developer`, `operations` |
| [code-review](../skills/code-review/SKILL.md) | Code review standards and PR quality checklists | `developer` |
| [critical-feedback](../skills/critical-feedback/SKILL.md) | Rigorous critical analysis and devil's advocate methodology for any design, strategy, or proposal | `general`, `manager`, `developer`, `executive` |
| [data-analysis](../skills/data-analysis/SKILL.md) | Data analysis workflows with pandas, Polars, and DuckDB | `analyst`, `researcher`, `developer` |
| [data-migrations](../skills/data-migrations/SKILL.md) | Zero-downtime schema and backfill migration patterns | `developer`, `operations` |
...
| [dependency-management](../skills/dependency-management/SKILL.md) | Dependency evaluation, supply chain security, and maintenance | `developer`, `operations` |
...
| [ide-setup](../skills/ide-setup/SKILL.md) | IDE configuration and extension management for VS Code, Cursor, and Claude Code | `developer` |
...
| [anomaly-detection](../skills/anomaly-detection/SKILL.md) | Anomaly detection methodology selection and pipeline design for time series, tabular data, and event streams | `analyst`, `developer`, `operations` |
...
| [product-management](../skills/product-management/SKILL.md) | Product roadmapping, prioritization, and specification writing | `manager`, `operations`, `executive` |
...
| [reclassification](../skills/reclassification/SKILL.md) | Critically evaluate and improve any classification system — folders, labels, columns, or taxonomies | `general`, `analyst`, `developer` |
...
| [security](../skills/security/SKILL.md) | Application security standards and hardening practices | `developer`, `operations` |
| [statistics](../skills/statistics/SKILL.md) | Statistical method selection and hypothesis testing for data-driven decisions | `analyst`, `researcher`, `developer` |
...
*This catalog is regenerated from skill frontmatter. To add a skill, follow the
